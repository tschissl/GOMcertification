...
write.table(df, "df0.txt", row.names=FALSE, append=TRUE, col.names=FALSE)
  }
```

```{r}
df0 <- read.table("C:/Daten/projects/R/certification/df0.txt", header=T, quote="\"")
final <- ddply(df0, c("date","RM","measurand","based.on", "unit"), numcolwise(meanGOM))
write.csv(final,"OKUMall.csv")
```
#### final
